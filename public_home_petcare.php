...
<head>
    ...
    <link rel="stylesheet" href="Assets/style/public_home_petcare.css">
    <style>
        .dropdown {
            position: relative;
...
<body>
    ...
    <!-- Content Here -->
    <div class="content">
        <p>Empower yourself as a pet owner with our informative resources on <br>pet care,disease prevention, and health improvement..<br> Join our community in raising awareness and nurturing a stronger bond with your beloved furry companions!</p><br> <br>
        <a href="public_petcare" class="button">View More</a>
    </div>

    <!-- Fixed arrows -->
    <div class="arrow-container" style="left: 10px;"><a href="public_home_petfood" class="arrow">&#10094;</a></div>
    <div class="arrow-container" style="right: 10px;"><a href="#" class="arrow">&#10095;</a></div>
