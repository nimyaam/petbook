...
<head>
    ...
    <link rel="stylesheet" href="Assets/style/public_pet_healthcare2.css">
    <style>
       .dropdown {
            position: relative;
...
<body>
    ...
    <div class="content">
        ...
        <div class="container">
            <div class="box" onclick="location.href='public_symptom2';">
                <h2>Symptoms & Disease</h2>
                <p>Discover vital pet health insights and disease awareness here...</p>
                <div class="underline"></div>
            </div>
            <div class="box" onclick="location.href='public_diet2';">
                <h2>Diet control</h2>
                <p>Maintain your pet's health with proper diet control...</p>
                <div class="underline"></div>
            </div>
            
            <div class="box" onclick="location.href='public_hygiene2';">
                <h2>Pet Hygiene</h2>
